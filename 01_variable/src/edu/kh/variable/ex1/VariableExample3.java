...
public class VariableExample3 {
	...
	public static void main(String[]args) {
		...
		int abcdefg;
		int showMeTheMoney;
		int qwertyuiopasdfghjkllzxcvbnm; // 길이 제한 X
		...
		// 참고 : 변수명은 언어 제한이 없다
		// 단, 코드 공유 시 글자 깨짐이 발생할 수 있어 권장 X
        int 정수1;
        boolean 참거짓;
        ...
        String str1;
        str1 = "안녕하세요?"; // str1 변수의 초기화(최초로 값 대입)
        ...
        //초기화 한 다음에 초기화 해 =싹 다 지우고 변수 초기화 해
