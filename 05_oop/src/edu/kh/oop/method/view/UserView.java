...
import edu.kh.oop.method.model.no.User;
...
public class UserView {
	...
	//->필드에 존재하는 user참조 변수에 반환된 User 객체의 주소를 저장
	...
	//로그아웃
	public void logout() {
		if(loginUser !=null) { //로그인 되어 있을 경우
			loginUser=null;    //로그아웃
