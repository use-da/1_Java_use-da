...
//		}else {result="흰색";}
	...
	public void ex3() {
		//Switch문 식의 결과가 double형인 경우 -> 안됨
		//Switch 식은 int, String만 가능
		Scanner sc =new Scanner(System.in);
...
//		case0.5 : result = "김밥";
		...
		if(result==-1) {System.out.println("잘못 입력 하셨습니다.");
		}else {System.out.printf("%s은 %d원 입니다. \n", input, result);
		}
		}
	...
	public void ex5() {
		...
		//break가 없을 경우 ->다음 case가 연달아 수행된다
		//계절 판별(switch버전)
...
//		}
	...
	//자동 완성
	//상단 window-preference-java-editor-tempelet-new-apply
